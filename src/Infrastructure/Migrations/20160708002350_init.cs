        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    CourseTaughtId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTroop = table.Column<int>(nullable: false),
                    DateCreated = table.Column<DateTime>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false),
                    LastModified = table.Column<DateTime>(nullable: false),
                    NumQuestions = table.Column<int>(nullable: false),
                    NumResponses = table.Column<int>(nullable: false),
                    NumUnseenResponses = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Survey_ApplicationUser_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(nullable: true),
                    FullGuid = table.Column<Guid>(nullable: false),
                    LastName = table.Column<string>(nullable: true),
                    ShortGuid = table.Column<string>(nullable: true),
                    SurveyId = table.Column<int>(nullable: true),
                    TroopNum = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyToTake", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(nullable: false),
                    SurveyToTakeId = table.Column<int>(nullable: true),
