namespace SurveySays.Controllers {
    ...
    export class AccountController {
        ...
        constructor(private accountService: SurveySays.Services.AccountService, private $location: ng.ILocationService) {
    ...
    export class ConfirmEmailController {
        ...
        constructor(
            private accountService: SurveySays.Services.AccountService,
